...
parcelRegister("dsp30", function(module, exports) {

$parcel$export(module.exports, "ESP32S2ROM", () => $9cc151ca1fe3add2$export$4fb717d12681de23);

var $g3mQ9 = parcelRequire("g3mQ9");

var $hV2IC = parcelRequire("hV2IC");
class $9cc151ca1fe3add2$export$4fb717d12681de23 extends (0, $g3mQ9.ROM) {
    constructor(){
        super(...arguments);
        ...
        this.TEXT_START = (0, (/*@__PURE__*/$parcel$interopDefault($hV2IC))).text_start;
        this.ENTRY = (0, (/*@__PURE__*/$parcel$interopDefault($hV2IC))).entry;
        this.DATA_START = (0, (/*@__PURE__*/$parcel$interopDefault($hV2IC))).data_start;
        this.ROM_DATA = (0, (/*@__PURE__*/$parcel$interopDefault($hV2IC))).data;
        this.ROM_TEXT = (0, (/*@__PURE__*/$parcel$interopDefault($hV2IC))).text;
    }
...
parcelRegister("hV2IC", function(module, exports) {
...
//# sourceMappingURL=esp32s2.4ac70e50.js.map
