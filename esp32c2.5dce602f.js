...
parcelRegister("hmwWc", function(module, exports) {

$parcel$export(module.exports, "ESP32C2ROM", () => $ca3e0a78b6abe3b7$export$8ad31a2aa21b3abf);

var $iwpTN = parcelRequire("iwpTN");

var $jxTIt = parcelRequire("jxTIt");
class $ca3e0a78b6abe3b7$export$8ad31a2aa21b3abf extends (0, $iwpTN.ESP32C3ROM) {
    constructor(){
        super(...arguments);
        ...
        this.TEXT_START = (0, (/*@__PURE__*/$parcel$interopDefault($jxTIt))).text_start;
        this.ENTRY = (0, (/*@__PURE__*/$parcel$interopDefault($jxTIt))).entry;
        this.DATA_START = (0, (/*@__PURE__*/$parcel$interopDefault($jxTIt))).data_start;
        this.ROM_DATA = (0, (/*@__PURE__*/$parcel$interopDefault($jxTIt))).data;
        this.ROM_TEXT = (0, (/*@__PURE__*/$parcel$interopDefault($jxTIt))).text;
    }
...
parcelRegister("jxTIt", function(module, exports) {
...
//# sourceMappingURL=esp32c2.5dce602f.js.map
