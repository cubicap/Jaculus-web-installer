...
parcelRegister("4a0iZ", function(module, exports) {

$parcel$export(module.exports, "ESP32C6ROM", () => $30785535d3fa72f3$export$652353697ef98b38);

var $g3mQ9 = parcelRequire("g3mQ9");

var $glTLC = parcelRequire("glTLC");
class $30785535d3fa72f3$export$652353697ef98b38 extends (0, $g3mQ9.ROM) {
    constructor(){
        super(...arguments);
        ...
        this.TEXT_START = (0, (/*@__PURE__*/$parcel$interopDefault($glTLC))).text_start;
        this.ENTRY = (0, (/*@__PURE__*/$parcel$interopDefault($glTLC))).entry;
        this.DATA_START = (0, (/*@__PURE__*/$parcel$interopDefault($glTLC))).data_start;
        this.ROM_DATA = (0, (/*@__PURE__*/$parcel$interopDefault($glTLC))).data;
        this.ROM_TEXT = (0, (/*@__PURE__*/$parcel$interopDefault($glTLC))).text;
    }
...
parcelRegister("glTLC", function(module, exports) {
...
//# sourceMappingURL=esp32c6.b55cbf13.js.map
